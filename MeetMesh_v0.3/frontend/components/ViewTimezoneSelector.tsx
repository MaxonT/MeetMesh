      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-2 text-xs">
          {isViewingEventTimezone && (
            <span className="inline-flex items-center px-2 py-1 rounded-md bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200">
          ...
          {!isViewingEventTimezone && !isViewingUserTimezone && (
            <span className="inline-flex items-center px-2 py-1 rounded-md bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-200">
              <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
